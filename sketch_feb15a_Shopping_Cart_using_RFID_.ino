...
const char* ssid = "Paresh";//Replace with your network SSID
const char* password = "9664361012";//Replace with your network password
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "14004AA231CD", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "14004AA231CD", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "140049DFC446", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "140049DFC446", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "3B003B47FEB9", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "3B003B47FEB9", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "3B003B61B4D5", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "3B003B61B4D5", 12) == 0) && (a == 0))
      {
        if(p4>0)
        {
        lcd.clear();
      ...
      else if (strncmp(input, "3B003B612A4B", 12) == 0)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
